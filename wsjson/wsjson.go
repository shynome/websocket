...
func Read(ctx context.Context, c *websocket.StdConn, v interface{}) error {
	return read(ctx, c, v)
}

func read(ctx context.Context, c *websocket.StdConn, v interface{}) (err error) {
...
// It will reuse buffers in between calls to avoid allocations.
func Write(ctx context.Context, c *websocket.StdConn, v interface{}) error {
	return write(ctx, c, v)
}

func write(ctx context.Context, c *websocket.StdConn, v interface{}) (err error) {
