...
func Dial(ctx context.Context, u string, opts *DialOptions) (*StdConn, *http.Response, error) {
	return dial(ctx, u, opts, nil)
}

func dial(ctx context.Context, urls string, opts *DialOptions, rand io.Reader) (_ *StdConn, _ *http.Response, err error) {
